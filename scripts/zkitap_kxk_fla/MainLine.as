package z_kitap_kxk_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      public var mcNavi0:MovieClip;
      
      public var mcNavi1:MovieClip;
      ...
      public var toolBarBottom:MovieClip;
      ...
      public var _macStoreStatus:Boolean;
      ...
      public var _passwordType:String;
      ...
      public var _soDeviceID:SharedObject;
      
      public var _window:NativeWindow;
      
      public var _argsFile:File;
      
      public var _urlLoaderArgs:URLLoader;
      ...
      {
         trace(this._fernusLink + "&action=check_key_status&key=" + this._fernusKey + "&book=" + this._bookName);
      ...
      public function align() : *
      {
         ...
         var _spaceBottomX:Number = (this._capX - this.toolBarBottom.mcLeft.width - this.toolBarBottom.mcRight.width) / 3;
         this.toolBarBottom.mcLeft.x = 10;
         this.toolBarBottom.mcRight.x = _spaceBottomX + this.toolBarBottom.mcLeft.width;
         this.toolBarBottom.bg.width = this.toolBarBottom.mcLeft.width * 2 + _spaceBottomX + 20;
         this.stageCoor(this.toolBarBottom,(this._capX - this.toolBarBottom.width) / 2,this._capY - this.toolBarBottom.height - this._capYOffset - 10);
         this.objectCache(this.toolBarBottom.bg);
         ...
         this.mcNavi0.visible = true;
         this.mcNavi1.visible = true;
         this.stageCoor(this.mcNavi0,10,(this._capY - this.mcNavi0.height) / 2);
         this.stageCoor(this.mcNavi1,this._capX - 10 - this.mcNavi1.width,(this._capY - this.mcNavi1.height) / 2);
         this._int = 10;
         ...
         this.toolBarBottom.mcLeft.fernusColorPalette.visible = false;
         this.toolBarBottom.mcLeft.fernusLinePalette.visible = false;
         this.toolBarBottom.mcLeft.fernusGrapsPalette.visible = false;
         this.toolBarBottom.mcRight.fernusColorPalette.visible = false;
         this.toolBarBottom.mcRight.fernusLinePalette.visible = false;
         this.toolBarBottom.mcRight.fernusGrapsPalette.visible = false;
         this.objectCache(this.mcNavi0);
         this.objectCache(this.mcNavi1);
      ...
      {
         var date1Timestamp:Number = Number(date1.getTime());
         var date2Timestamp:Number = Number(date2.getTime());
         var result:Number = -1;
      ...
      public function checkKeyCode() : *
      {
         ...
         this.stageFill(this.mcBg);
         this.objectCache(this.mcBg);
         if(this._passwordType == "normal" || this._passwordType == "ask")
         {
      ...
      public function checkSavedKey() : *
      {
         ...
         if(this._passwordType == "normal" && FileManager.exists(this._tempPath + this._soKXKKey))
         {
            _ul = new URLLoader();
      ...
      public function enterKey() : *
      {
         ...
         this.pnlKey.con.mcSerial.bvis.addEventListener(MouseEvent.CLICK,this.changeKeyVis);
         this.pnlKey.con.mcSerial.bvis.gotoAndStop(int(this.pnlKey.con.mcSerial.txtKey.displayAsPassword) + 1);
      }
      
      public function changeKeyVis(e:MouseEvent) : *
      {
         var _str:* = this.pnlKey.con.mcSerial.txtKey.text;
         this.pnlKey.con.mcSerial.txtKey.text = "";
         this.pnlKey.con.mcSerial.txtKey.displayAsPassword = !this.pnlKey.con.mcSerial.txtKey.displayAsPassword;
         this.pnlKey.con.mcSerial.bvis.gotoAndStop(int(this.pnlKey.con.mcSerial.txtKey.displayAsPassword) + 1);
         this.pnlKey.con.mcSerial.txtKey.text = _str;
      }
      
      public function checkKey(e:MouseEvent) : *
      {
         this.pnlKey.con.mcSerial.txtKey.text = this.trim(this.pnlKey.con.mcSerial.txtKey.text);
      ...
      public function xmlComplete(e:Event) : void
      {
         ...
         if(0 < this._xml.maskcurtains.length())
         {
            if(this._xml.maskcurtains != "")
            {
               this.curtainItems = new Array();
               this._int = 0;
               for each(curtainItem in this._xml.maskcurtains.mask)
               {
                  this.curtainItems[this._int] = new Array();
                  this.curtainItems[this._int]["page"] = int(curtainItem.page) + this._jump;
                  this.curtainItems[this._int]["coor"] = new Point();
                  this.curtainItems[this._int]["coor"].x = curtainItem.imCoor.split(",")[0];
                  this.curtainItems[this._int]["coor"].y = curtainItem.imCoor.split(",")[1];
         ...
         for each(game in this._xml.games.item)
         {
            ...
            if(game.hasOwnProperty("scale"))
            {
               this._activities[this._int].scale = Number(game.scale);
            }
            ++this._int;
         }
         this._int = 0;
      ...
      public function bookLoadingCompleted(e:LoaderEvent = null) : void
      {
         ...
         this.mcNavi0.b1.addEventListener(MouseEvent.CLICK,this._nextPage);
         this.mcNavi0.b0.addEventListener(MouseEvent.CLICK,this._previousPage);
         this.mcNavi1.b1.addEventListener(MouseEvent.CLICK,this._nextPage);
         this.mcNavi1.b0.addEventListener(MouseEvent.CLICK,this._previousPage);
         ...
         this.toolBarBottom.mcLeft.btnMode.mcicon.gotoAndStop(2);
         this.toolBarBottom.mcRight.btnMode.mcicon.gotoAndStop(2);
         this.trs.enabled = true;
         this.goActiveTool(4);
         this.activated(this.toolBar.btnMove);
         this.colorize(this.toolBarBottom.mcLeft.btnMove,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.btnMove,this._overColor);
         this.openAllEvent();
         this.addStage(this._canvas);
         this.addStage(this._curtain);
         this.addStage(this.panelCast);
         this.addStage(this.toolBar);
         this.addStage(this.toolBarBottom);
         ...
         this.addStage(this.mcNavi0);
         this.addStage(this.mcNavi1);
      ...
      public function stage_keyboard(e:KeyboardEvent) : void
      {
         ...
         else if(e.keyCode == Keyboard.F5)
         {
            if(!this.zenbB && !this._inputTextStatus && !this._ahSelectStatus)
            {
               for(key1 in this.selectItems)
               {
                  ...
                  {
                     if(this.selectItems[key1]["page"] == this.guncelSayfa && Boolean(this.selectItems[key1]["im"]))
                     {
         ...
         {
            if(this.isIm && Boolean(this.footer.closeZoom.visible))
            {
               this._closeZoom();
            }
         }
      ...
      public function showAllMaskAni() : *
      {
         ...
         {
            for(i = int(this._currAniObject.num); i < this._currAniObject.rects.length; i++)
            {
               this.nextMaskAni();
            }
         }
      ...
      public function _fernusColorPicker(e:MouseEvent) : void
      {
         ...
         this.toolBar.fernusLinePalette.visible = false;
         this.toolBar.fernusGrapsPalette.visible = false;
         if(this.toolBarBottom.mcLeft.fernusColorPalette.visible)
         {
            this.toolBarBottom.mcLeft.fernusColorPalette.visible = false;
            this.toolBarBottom.mcLeft.fernusColorPalette.removeEventListener(MouseEvent.CLICK,this._fernusColorPalette);
         }
         else
         {
            this.toolBarBottom.mcLeft.fernusColorPalette.visible = true;
            this.toolBarBottom.mcLeft.fernusColorPalette.addEventListener(MouseEvent.CLICK,this._fernusColorPalette);
         }
         this.toolBarBottom.mcLeft.fernusLinePalette.visible = false;
         this.toolBarBottom.mcLeft.fernusGrapsPalette.visible = false;
         if(this.toolBarBottom.mcRight.fernusColorPalette.visible)
         {
            this.toolBarBottom.mcRight.fernusColorPalette.visible = false;
            this.toolBarBottom.mcRight.fernusColorPalette.removeEventListener(MouseEvent.CLICK,this._fernusColorPalette);
         }
         else
         {
            this.toolBarBottom.mcRight.fernusColorPalette.visible = true;
            this.toolBarBottom.mcRight.fernusColorPalette.addEventListener(MouseEvent.CLICK,this._fernusColorPalette);
         }
         this.toolBarBottom.mcRight.fernusLinePalette.visible = false;
         this.toolBarBottom.mcRight.fernusGrapsPalette.visible = false;
         this.playSound("b");
      ...
      public function _fernusColorPalette(e:MouseEvent) : void
      {
         ...
         {
            this.toolBarBottom.mcLeft.fernusColorPalette.removeEventListener(MouseEvent.CLICK,this._fernusColorPalette);
            this.toolBarBottom.mcLeft.fernusColorPicker.mcicon.pickedColor.transform.colorTransform = this.myColorTransform;
            this.toolBarBottom.mcLeft.fernusColorPalette.visible = false;
         }
         else
         {
         ...
         {
            this.toolBarBottom.mcRight.fernusColorPalette.removeEventListener(MouseEvent.CLICK,this._fernusColorPalette);
            this.toolBarBottom.mcRight.fernusColorPicker.mcicon.pickedColor.transform.colorTransform = this.myColorTransform;
            this.toolBarBottom.mcRight.fernusColorPalette.visible = false;
         }
         else
         {
      ...
      public function _fernusLinePicker(e:MouseEvent) : void
      {
         ...
         this.toolBar.fernusGrapsPalette.visible = false;
         this.toolBar.fernusColorPalette.visible = false;
         if(this.toolBarBottom.mcLeft.fernusLinePalette.visible)
         {
            this.toolBarBottom.mcLeft.fernusLinePalette.visible = false;
            this.toolBarBottom.mcLeft.fernusLinePalette.removeEventListener(MouseEvent.CLICK,this._fernusLinePalette);
         }
         else
         {
            this.toolBarBottom.mcLeft.fernusLinePalette.visible = true;
            this.toolBarBottom.mcLeft.fernusLinePalette.addEventListener(MouseEvent.CLICK,this._fernusLinePalette);
         }
         this.toolBarBottom.mcLeft.fernusGrapsPalette.visible = false;
         this.toolBarBottom.mcLeft.fernusColorPalette.visible = false;
         if(this.toolBarBottom.mcRight.fernusLinePalette.visible)
         {
            this.toolBarBottom.mcRight.fernusLinePalette.visible = false;
            this.toolBarBottom.mcRight.fernusLinePalette.removeEventListener(MouseEvent.CLICK,this._fernusLinePalette);
         }
         else
         {
            this.toolBarBottom.mcRight.fernusLinePalette.visible = true;
            this.toolBarBottom.mcRight.fernusLinePalette.addEventListener(MouseEvent.CLICK,this._fernusLinePalette);
         }
         this.toolBarBottom.mcRight.fernusGrapsPalette.visible = false;
         this.toolBarBottom.mcRight.fernusColorPalette.visible = false;
         this.playSound("b");
      ...
      public function _fernusLinePalette(e:MouseEvent) : void
      {
         ...
         {
            this.toolBarBottom.mcLeft.fernusLinePalette.removeEventListener(MouseEvent.CLICK,this._fernusLinePalette);
            this.toolBarBottom.mcLeft.fernusLinePicker.mcicon.lineCircle.width = this.toolBarBottom.mcLeft.fernusLinePicker.mcicon.lineCircle.height = Number(e.target.parent.name.split("_")[1]) * 3;
            this.toolBarBottom.mcLeft.fernusLinePalette.visible = false;
         }
         else
         {
         ...
         {
            this.toolBarBottom.mcRight.fernusLinePalette.removeEventListener(MouseEvent.CLICK,this._fernusLinePalette);
            this.toolBarBottom.mcRight.fernusLinePicker.mcicon.lineCircle.width = this.toolBarBottom.mcRight.fernusLinePicker.mcicon.lineCircle.height = Number(e.target.parent.name.split("_")[1]) * 3;
            this.toolBarBottom.mcRight.fernusLinePalette.visible = false;
         }
         else
         {
      ...
      public function _btnGraps(e:MouseEvent) : void
      {
         ...
         this.toolBar.fernusLinePalette.visible = false;
         this.toolBar.fernusColorPalette.visible = false;
         if(this.toolBarBottom.mcLeft.fernusGrapsPalette.visible)
         {
            this.toolBarBottom.mcLeft.fernusGrapsPalette.visible = false;
            this.toolBarBottom.mcLeft.fernusGrapsPalette.removeEventListener(MouseEvent.CLICK,this._fernusGrapsPalette);
         }
         else
         {
            this.toolBarBottom.mcLeft.fernusGrapsPalette.visible = true;
            this.toolBarBottom.mcLeft.fernusGrapsPalette.addEventListener(MouseEvent.CLICK,this._fernusGrapsPalette);
         }
         this.toolBarBottom.mcLeft.fernusLinePalette.visible = false;
         this.toolBarBottom.mcLeft.fernusColorPalette.visible = false;
         if(this.toolBarBottom.mcRight.fernusGrapsPalette.visible)
         {
            this.toolBarBottom.mcRight.fernusGrapsPalette.visible = false;
            this.toolBarBottom.mcRight.fernusGrapsPalette.removeEventListener(MouseEvent.CLICK,this._fernusGrapsPalette);
         }
         else
         {
            this.toolBarBottom.mcRight.fernusGrapsPalette.visible = true;
            this.toolBarBottom.mcRight.fernusGrapsPalette.addEventListener(MouseEvent.CLICK,this._fernusGrapsPalette);
         }
         this.toolBarBottom.mcRight.fernusLinePalette.visible = false;
         this.toolBarBottom.mcRight.fernusColorPalette.visible = false;
         this.playSound("b");
      ...
      public function openGraps(o:MovieClip) : *
      {
         ...
         this.colorize(this.toolBarBottom.mcLeft.btnGraps,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.btnGraps,this._overColor);
         this.toolBarBottom.mcLeft.btnGraps.mcicon.maske.gotoAndStop(2);
         this.toolBarBottom.mcLeft.btnGraps.mcicon.gotoAndStop(o.name.split("_")[2]);
         this.toolBarBottom.mcRight.btnGraps.mcicon.maske.gotoAndStop(2);
         this.toolBarBottom.mcRight.btnGraps.mcicon.gotoAndStop(o.name.split("_")[2]);
      }
      ...
      public function _btnMove(e:MouseEvent) : void
      {
         ...
         this.toolBar.fernusLinePalette.visible = false;
         this.toolBar.fernusGrapsPalette.visible = false;
         this.colorize(this.toolBar.btnMove,this._overColor);
         this.colorize(this.toolBarBottom.mcLeft.btnMove,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.btnMove,this._overColor);
         this.toolBarBottom.mcLeft.fernusColorPalette.visible = false;
         this.toolBarBottom.mcLeft.fernusLinePalette.visible = false;
      ...
      public function _btnBrush(e:MouseEvent) : void
      {
         ...
         this.goActiveTool(1);
         this.activated(e.currentTarget);
         this.colorize(this.toolBar.btnBrush,this._overColor);
         this.colorize(this.toolBarBottom.mcLeft.btnBrush,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.btnBrush,this._overColor);
      }
      ...
      public function _btnSelect(e:MouseEvent) : void
      {
         ...
         this._closeZoom();
         this.activated(e.currentTarget);
         this.colorize(this.toolBar.zoomTool.btnSelect,this._overColor);
         this.colorize(this.toolBarBottom.mcLeft.zoomTool.btnSelect,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.zoomTool.btnSelect,this._overColor);
      }
      ...
      public function _btnMark(e:MouseEvent) : void
      {
         ...
         this.goActiveTool(9);
         this.activated(e.currentTarget);
         this.colorize(this.toolBar.btnMark,this._overColor);
         this.colorize(this.toolBarBottom.mcLeft.btnMark,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.btnMark,this._overColor);
      }
      ...
      public function _btnErase(e:MouseEvent) : void
      {
         ...
         this.goActiveTool(7);
         this.activated(e.currentTarget);
         this.colorize(this.toolBar.btnErase,this._overColor);
         this.colorize(this.toolBarBottom.mcLeft.btnErase,this._overColor);
         this.colorize(this.toolBarBottom.mcRight.btnErase,this._overColor);
      }
      ...
      public function activated(o:Object) : *
      {
         ...
         this.stopColorize(this.toolBarBottom.mcLeft.btnBrush);
         this.stopColorize(this.toolBarBottom.mcLeft.zoomTool.btnSelect);
         this.stopColorize(this.toolBarBottom.mcLeft.btnMark);
         this.stopColorize(this.toolBarBottom.mcLeft.btnErase);
         this.stopColorize(this.toolBarBottom.mcLeft.btnGraps);
         this.stopColorize(this.toolBarBottom.mcLeft.btnMove);
         this.toolBarBottom.mcLeft.btnGraps.mcicon.gotoAndStop(1);
         this.toolBarBottom.mcLeft.btnGraps.mcicon.maske.gotoAndStop(1);
         this.stopColorize(this.toolBarBottom.mcRight.btnBrush);
         this.stopColorize(this.toolBarBottom.mcRight.zoomTool.btnSelect);
         this.stopColorize(this.toolBarBottom.mcRight.btnMark);
         this.stopColorize(this.toolBarBottom.mcRight.btnErase);
         this.stopColorize(this.toolBarBottom.mcRight.btnGraps);
         this.stopColorize(this.toolBarBottom.mcRight.btnMove);
         this.toolBarBottom.mcRight.btnGraps.mcicon.gotoAndStop(1);
         this.toolBarBottom.mcRight.btnGraps.mcicon.maske.gotoAndStop(1);
      ...
      public function lockToolbar(e:MouseEvent = null) : *
      {
         this._isToolbarLocked = !this._isToolbarLocked;
         this.toolBar.visible = !this._isToolbarLocked;
         this.toolBarBottom.visible = this._isToolbarLocked;
      }
      ...
      public function onFrame(e:MouseEvent) : void
      {
         ...
         if(this.isDrawing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
            this.pointler[this.sayac++] = {
      ...
      public function onMarkFrame(e:MouseEvent) : void
      {
         this.currentPoint = new Point(this._canvas.mouseX,this._canvas.mouseY);
         this.currentPoint = new Point(this.currentPoint.x,this.lastPoint.y + (this.currentPoint.y - this.lastPoint.y) * 0.5);
         if(this.isMarking && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
            this.pointler[this.sayac++] = {
               "x":this.currentPoint.x,
               "y":this.currentPoint.y
      ...
      {
         if(this.isLineDrawing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
      ...
      public function eraseOnFrame(e:MouseEvent) : void
      {
         this.currentPoint = new Point(this._canvas.mouseX,this._canvas.mouseY);
         this.currentPoint = new Point(this.currentPoint.x,this.lastPoint.y + (this.currentPoint.y - this.lastPoint.y) * 0.5);
         if(this.isErasing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
      ...
      public function arrowOnFrame(e:MouseEvent) : void
      {
         ...
         if(this.isArrowDrawing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
            _angleDegree = 45;
      ...
      {
         if(this.isCircleDrawing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
            this.tempShape.graphics.clear();
      ...
      public function onStopCircle(e:MouseEvent) : void
      {
         ...
         this.lastPoint = new Point(this._canvas.mouseX,this._canvas.mouseY);
         if(Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)) && this.startPoint.x != this.lastPoint.x && this.startPoint.y != this.lastPoint.y)
         {
            ++this.brushLayer;
            if(this.isIm && this.imMode == 0)
            {
      ...
      {
         if(this.isSquareDrawing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
            this.tempShape.graphics.clear();
            this.tempShape.graphics.lineStyle(this.activeLineWidth,this.activeColor,1,true,LineScaleMode.NORMAL,CapsStyle.ROUND,JointStyle.ROUND);
      ...
      public function triangleOnFrame(e:MouseEvent) : void
      {
         ...
         if(this.isTriangeDrawing && Boolean(_pm.hitTestPoint(mouseX,mouseY,true)))
         {
            this.currentPoint = new Point(this._canvas.mouseX,this._canvas.mouseY);
            _distance1 = this.distanceTwoPoints(this.startPoint.x,this.startPoint.y,this.currentPoint.x,this.currentPoint.y) / 2;
            _x = Number(Math.abs(this.startPoint.x - this.currentPoint.x));
            _y = Number(Math.abs(this.startPoint.y - this.currentPoint.y));
            _p = new Array();
            _p[0] = {
               "x":this.startPoint.x,
               "y":this.startPoint.y
      ...
      public function onStopTriangle(e:MouseEvent) : void
      {
         ...
         if(Boolean(_pm.hitTestPoint(mouseX,mouseY,true)) && this.startPoint.x != this.lastPoint.x && this.startPoint.y != this.lastPoint.y)
         {
            _distance1 = this.distanceTwoPoints(this.startPoint.x,this.startPoint.y,this.lastPoint.x,this.lastPoint.y) / 2;
            _x = Number(Math.abs(this.startPoint.x - this.lastPoint.x));
            _y = Number(Math.abs(this.startPoint.y - this.lastPoint.y));
            _p = new Array();
            _p[0] = {
               "x":this.startPoint.x,
               "y":this.startPoint.y
      ...
      {
         if(this.isSelectDrawing && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)))
         {
            this.tempShape.graphics.clear();
      ...
      public function selectCalc(_rectangle:Rectangle, _numF:Number) : *
      {
         ...
         this._canvas.x = Number(this._empPoint.x) - _rectangle.x * this._scale;
         this._canvas.y = Number(this._empPoint.y) - _rectangle.y * this._scale;
         this._canvas.scaleX = this._scale;
         this._canvas.scaleY = this._scale;
      }
      ...
      public function onStopSelect(e:MouseEvent) : void
      {
         ...
         if(!this._kapBl && Boolean(this._canvas.hitTestPoint(mouseX,mouseY,true)) && this.startPoint.x != this.lastPoint.x && this.startPoint.y != this.lastPoint.y && this._scale < 500)
         {
      ...
      {
         if(this.brushLayer != 0 && Boolean(this.drawAreas[this.guncelSayfa].contains(this.brushAreas[this.brushLayer])))
         {
      ...
      public function openAllEvent() : *
      {
         ...
         this.toolBarBottom.mcLeft.fernusColorPicker.addEventListener(MouseEvent.CLICK,this._fernusColorPicker);
         this.toolBarBottom.mcLeft.fernusLinePicker.addEventListener(MouseEvent.CLICK,this._fernusLinePicker);
         this.toolBarBottom.mcLeft.btnGraps.addEventListener(MouseEvent.CLICK,this._btnGraps);
         this.toolBarBottom.mcLeft.zoomTool.btnSelect.addEventListener(MouseEvent.CLICK,this._btnSelect);
         this.toolBarBottom.mcLeft.zoomTool.zoomIn.addEventListener(MouseEvent.CLICK,this._zoomIn);
         this.toolBarBottom.mcLeft.zoomTool.zoomOut.addEventListener(MouseEvent.CLICK,this._zoomOut);
         this.toolBarBottom.mcLeft.btnMove.addEventListener(MouseEvent.CLICK,this._btnMove);
         this.toolBarBottom.mcLeft.btnBrush.addEventListener(MouseEvent.CLICK,this._btnBrush);
         this.toolBarBottom.mcLeft.btnMark.addEventListener(MouseEvent.CLICK,this._btnMark);
         this.toolBarBottom.mcLeft.btnErase.addEventListener(MouseEvent.CLICK,this._btnErase);
         this.toolBarBottom.mcLeft.btnBack.addEventListener(MouseEvent.CLICK,this.goBack);
         this.toolBarBottom.mcLeft.btnMode.addEventListener(MouseEvent.CLICK,this.changeMode);
         this.toolBarBottom.mcLeft.btnCleanScreen.addEventListener(MouseEvent.CLICK,this.eraseScreen);
         this.toolBarBottom.mcRight.fernusColorPicker.addEventListener(MouseEvent.CLICK,this._fernusColorPicker);
         this.toolBarBottom.mcRight.fernusLinePicker.addEventListener(MouseEvent.CLICK,this._fernusLinePicker);
         this.toolBarBottom.mcRight.btnGraps.addEventListener(MouseEvent.CLICK,this._btnGraps);
         this.toolBarBottom.mcRight.zoomTool.btnSelect.addEventListener(MouseEvent.CLICK,this._btnSelect);
         this.toolBarBottom.mcRight.zoomTool.zoomIn.addEventListener(MouseEvent.CLICK,this._zoomIn);
         this.toolBarBottom.mcRight.zoomTool.zoomOut.addEventListener(MouseEvent.CLICK,this._zoomOut);
         this.toolBarBottom.mcRight.btnMove.addEventListener(MouseEvent.CLICK,this._btnMove);
         this.toolBarBottom.mcRight.btnBrush.addEventListener(MouseEvent.CLICK,this._btnBrush);
         this.toolBarBottom.mcRight.btnMark.addEventListener(MouseEvent.CLICK,this._btnMark);
         this.toolBarBottom.mcRight.btnErase.addEventListener(MouseEvent.CLICK,this._btnErase);
         this.toolBarBottom.mcRight.btnBack.addEventListener(MouseEvent.CLICK,this.goBack);
         this.toolBarBottom.mcRight.btnMode.addEventListener(MouseEvent.CLICK,this.changeMode);
         this.toolBarBottom.mcRight.btnCleanScreen.addEventListener(MouseEvent.CLICK,this.eraseScreen);
      }
      ...
      public function goToThePage(pNum:int) : void
      {
         ...
         var keyCurtain:String = null;
         var key:String = null;
         var _tfKey:String = null;
         var _key4:String = null;
         var key2:String = null;
         var key3:String = null;
         var _key5:String = null;
         this.playSound("p");
         this.closeCloseZoom();
         this.kapKontrol();
         this.vazgecF();
         ...
         if(this._activities)
         {
            ...
            {
               if(this._activities[key1].page == this.guncelSayfa && Boolean(this._activities[key1].im))
               {
                  if(this.pageItems[this.guncelSayfa])
                  {
         ...
         {
            if(this.curtainItems[keyCurtain]["page"] == this.guncelSayfa && Boolean(this.curtainItems[keyCurtain]["im"]))
            {
         ...
         if(this._maskChecker)
         {
            ...
            {
               if(this._masks[key2]["page"] == this.guncelSayfa && Boolean(this._masks[key2]["im"]))
               {
         ...
         for(keyCurtain in this.curtainItems)
         {
            ...
            {
               this.curtainItems[keyCurtain]["im"] = new im_txt();
               ...
               this.curtainItems[keyCurtain]["im"].x = this.curtainItems[keyCurtain]["coor"].x;
               this.curtainItems[keyCurtain]["im"].y = this.curtainItems[keyCurtain]["coor"].y;
         ...
         if(this._activities)
         {
            for(key1 in this._activities)
            {
               if(this._activities[key1].page == this.guncelSayfa)
               {
                  ...
                  if(this._activities[key1].scale)
                  {
                     this._activities[key1].im.scaleX = this._activities[key1].im.scaleY = this._activities[key1].scale;
                  }
         ...
         if(Boolean(this.drawAreas2[pNum]) && Boolean(this.drawAreas2[pNum][0]))
         {
      ...
      public function searchGo(e:MouseEvent) : void
      {
         ...
         if(this.searchPanel.word.text != "" && this.searchPanel.word.text != " " && this.searchPanel.word.text != "  " && this.searchPanel.word.text.length > 1)
         {
            ...
            {
               index = int(this.buyukHarf(this._pages[key]["content"]).indexOf(this.buyukHarf(this._empString)));
               if(index > -1)
               {
      ...
      public function mouseUpHandlerK(event:MouseEvent = null) : void
      {
         ...
         time = (getTimer() - this.tk2) / 1000;
         yVelocity = (this._scrollMc2.y - this.yk2) / time;
      ...
      public function button_geogebra(e:MouseEvent = null) : void
      {
         ...
         _folder = File.applicationStorageDirectory.resolvePath("GeoGebra");
      ...
      public function downloadGeoGebra() : void
      {
         ...
         _filename = this._soGeoGebra.data.file_url.split("/")[this._soGeoGebra.data.file_url.split("/").length - 1];
         this._kxkDownloader = new KXKDownloader(this._soGeoGebra.data.file_url,this._tempPath + _filename,this._soGeoGebra.data.file_size);
         ...
         this._kxkDownloader.addEventListener(Event.COMPLETE,function():void
         {
            ...
            {
               _zipFM.unzipFileSFX(_tempPath + _filename,_folder.url);
            }
            else
            {
               _zipFM.unzipFileOnMac(_tempPath + _filename,_folder.url);
            }
         });
         ...
         if(e.currentTarget.name == "bopen")
         {
            try
            {
               ...
               else
               {
                  ...
                  _processArgs.push("-n");
                  _processArgs.push(File.applicationStorageDirectory.resolvePath("GeoGebra/" + this._soGeoGebra.data.executable_file).nativePath);
                  _startupInfo.executable = new File("/usr/bin/open");
                  _startupInfo.workingDirectory = File.applicationStorageDirectory.resolvePath("GeoGebra");
                  _startupInfo.arguments = _processArgs;
                  _np = new NativeProcess();
                  _np.start(_startupInfo);
               }
            }
      ...
      {
         if(this.brushLayer2 != 0 && Boolean(this.drawAreas2[this.guncelSayfa][this.hangiNot].contains(this.brushAreas2[this.brushLayer2])))
         {
      ...
      public function onStartDraw2(e:MouseEvent) : void
      {
         ...
         if(!this.isDrawing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            this.pointler = [];
            this.sayac = 0;
            ++this.brushLayer2;
      ...
      public function onStartMark2(e:MouseEvent) : void
      {
         ...
         if(!this.isMarking && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            this.pointler = [];
            this.sayac = 0;
            ++this.brushLayer2;
      ...
      {
         if(this.isLineDrawing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            this.tempShape.graphics.clear();
            this.tempShape.graphics.lineStyle(this.activeLineWidth,this.activeColor,1,true,LineScaleMode.NORMAL,CapsStyle.ROUND,JointStyle.ROUND);
            this.tempShape.graphics.moveTo(this.startPoint.x,this.startPoint.y);
      ...
      {
         if(!this.isErasing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
      ...
      public function arrowOnFrame2(e:MouseEvent) : void
      {
         ...
         var _h:Number = NaN;
         var _angleDeg:Number = NaN;
         if(this.isArrowDrawing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            _angleDegree = 45;
            _size = this.activeLineWidth;
      ...
      {
         if(this.isCircleDrawing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            this.tempShape.graphics.clear();
            this.tempShape.graphics.lineStyle(this.activeLineWidth,this.activeColor,1);
      ...
      {
         if(this.isSquareDrawing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            this.tempShape.graphics.clear();
            this.tempShape.graphics.lineStyle(this.activeLineWidth,this.activeColor,1,true,LineScaleMode.NORMAL,CapsStyle.ROUND,JointStyle.ROUND);
      ...
      public function triangleOnFrame2(e:MouseEvent) : void
      {
         ...
         var _y:Number = NaN;
         var _p:Array = null;
         if(this.isTriangeDrawing && Boolean(this._note.bg1.hitTestPoint(mouseX,mouseY,true)))
         {
            this.currentPoint = new Point(this._note.mouseX,this._note.mouseY - 77.4);
            _distance1 = this.distanceTwoPoints(this.startPoint.x,this.startPoint.y,this.currentPoint.x,this.currentPoint.y) / 2;
            _x = Number(Math.abs(this.startPoint.x - this.currentPoint.x));
         ...
         if(!this._isWhite)
         {
            if(!this.isIm)
            {
               if(this.imMode == 0)
               {
                  ...
                  this.toolBarBottom.mcLeft.btnMode.mcicon.gotoAndStop(1);
                  this.toolBarBottom.mcRight.btnMode.mcicon.gotoAndStop(1);
      ...
      public function kapKontrol() : *
      {
         ...
         if(this.imMode == 0)
         {
            ...
            for(key in this.selectItems)
            {
               if(this.selectItems[key]["page"] == this.guncelSayfa && Boolean(this.selectItems[key]["im"]))
               {
      ...
      public function areaManuel() : void
      {
         ...
         _scale = Number(Math.min(this.mcObjectPanel.mcBg.width / this._displayObject.loaderInfo.width,this.mcObjectPanel.mcBg.height / this._displayObject.loaderInfo.height));
      ...
      public function zengModu(e:MouseEvent) : void
      {
         if(!this.zenbB)
         {
            ...
            this.toolBarBottom.visible = false;
      ...
      public function kaydetmeZeng(e:MouseEvent = null) : *
      {
         ...
         if(this._isToolbarLocked)
         {
            this.toolBarBottom.visible = true;
         }
         else
         {
      ...
      public function onStartSelectZeng(e:MouseEvent) : void
      {
         ...
         if(!this.isSelectDrawingZeng && Boolean(this._book.hitTestPoint(mouseX,mouseY,true)))
         {
            this.startPoint = new Point(this._canvas.mouseX,this._canvas.mouseY);
      ...
      public function onStopSelectZeng(e:MouseEvent) : void
      {
         ...
         if(Boolean(this._book.hitTestPoint(mouseX,mouseY,true)) && this.startPoint.x != this.lastPoint.x && this.startPoint.y != this.lastPoint.y && this._scale < 500)
         {
            if(this.startPoint.x < this.lastPoint.x)
            {
               if(this.startPoint.y < this.lastPoint.y)
      ...
      public function studentPanelHandlerButton(e:MouseEvent = null) : *
      {
         ...
         {
            _n = Number(Number(this.panelStudent.pnl1.txt.text));
            if(Boolean(isNaN(_n)) || this.panelStudent.pnl1.txt.text == "")
            {
      ...
      public function bannerCompleteHandler(e:LoaderEvent) : *
      {
         ...
         _scale = 1;
         _margin = 10;
         _scale = Number(Math.min(this._capX / 3 / this._bannerLoader.rawContent.width,this._capY / 3 / this._bannerLoader.rawContent.height));
      ...
      public function saveTF(e:MouseEvent) : *
      {
         ...
         _index = int(this._arrayTF.length);
      ...
      public function stopSelectionForAH(e:MouseEvent = null) : *
      {
         ...
         if(10 < _bounds.width && 10 < _bounds.height)
         {
            ...
            _scaledBounds.x = Math.floor(_bounds.x * _s);
            _scaledBounds.y = Math.floor(_bounds.y * _s);
            _scaledBounds.width = Math.ceil(_bounds.width * _s);
            _scaledBounds.height = Math.ceil(_bounds.height * _s);
            _m = new Matrix();
            _m.scale(_s,_s);
            _bmpDataCanvas = new BitmapData(this._canvas.width / this._canvas.scaleX * _s,this._canvas.height / this._canvas.scaleX * _s);
            ...
            this._ahData.bd = new BitmapData(_scaledBounds.width,_scaledBounds.height);
            this._ahData.bd.copyPixels(_bmpDataCanvas,_scaledBounds,new Point());
            this.cancelAH();
      ...
      public function saveNewMeeting(e:MouseEvent = null) : *
      {
         ...
         if(this.panelMeetingAdd.con.comboProvider.selectedItem.data.toString() == "zoom" && Boolean(this._meetingData.zoom_authorization))
         {
      ...
      public function setIntro() : *
      {
         ...
         {
            var _s:Number = NaN;
            _s = Number(Math.min(_capX / e.width,_capY / e.height));
      ...
      public function onErrorArgs(e:IOErrorEvent) : void
      {
         this.closeApp();
      }
      
      public function onLoadedArgs(e:Event) : void
      {
         var _s:String = null;
         this._invokeS = true;
         _s = e.target.data;
         ...
         if(this._argsFile.exists)
         {
            this._argsFile.deleteFile();
         }
         this.checkWindowsStatus();
      }
      ...
      public function checkWindowsStatus() : *
      {
         ...
         if(this._operatingSystem == "windows")
         {
            _status = this._invokeS && Boolean(this._stageBounds) && Boolean(this._windowBounds);
         }
         else if(this._operatingSystem == "mac")
         {
            _status = this._invokeS && this._stageBounds && Boolean(this._windowBounds) && Boolean(this._macwindowBounds);
            if(_status)
            {
      ...
      public function loadPublisherData() : *
      {
         ...
         try
         {
            ...
            if(this._operatingSystem == "windows" && Boolean(new File(this._mainFolderPath + "kk-db.db").exists))
            {
      ...
      public function onComplete(e:Event) : void
      {
         ...
         var _geoGebra:* = undefined;
         var _passwordStatus:* = undefined;
         var _proMode:* = undefined;
         var _ds:Array = null;
         ...
         if(_j.serverStatus)
         {
            this._fernusLink = String(_j.server) + "?publisher=" + this._pkxkname + "&os=" + this._operatingSystem + "&ln=" + this._appLanguage + "&uid=" + this._soDeviceID.data.id;
         }
         else
         {
            this._fernusLink = this._fernusLink + "?publisher=" + this._pkxkname + "&os=" + this._operatingSystem + "&ln=" + this._appLanguage + "&uid=" + this._soDeviceID.data.id;
         }
         this._publisherApi = String(_j.server) + "?publisher=" + this._pkxkname + "&os=" + this._operatingSystem + "&ln=" + this._appLanguage + "&uid=" + this._soDeviceID.data.id;
         _geoGebra = false;
         if(_j.hasOwnProperty("geoGebra"))
         {
            _geoGebra = _j.geoGebra;
         }
         if(!_geoGebra)
         {
         ...
         if(_j.hasOwnProperty("passwordStatus"))
         {
            _passwordStatus = Boolean(_j.passwordStatus);
         }
         this._passwordType = "none";
         if(_passwordStatus)
         {
            this._passwordType = "normal";
         }
         if(_j.hasOwnProperty("passwordType"))
         {
            this._passwordType = _j.passwordType;
         }
         _proMode = false;
         ...
         {
            if(_j.hasOwnProperty("activeHomework"))
            {
               if(!Boolean(_j.activeHomework))
               {
                  this.closeProMode(this.footer.btnAH);
               }
            }
            if(_j.hasOwnProperty("onlineClassroom"))
            {
               if(!Boolean(_j.onlineClassroom))
               {
                  this.closeProMode(this.footer.btnMeeting);
               }
            }
